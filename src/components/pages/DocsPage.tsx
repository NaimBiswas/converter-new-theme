        ...
        <div className="space-y-6 text-sm text-[#191c1d] dark:text-[#e2e8f0]">
          <div>
            <h3 className="font-bold text-base text-[#191c1d] dark:text-white mb-1">
              Is there a file size limit for free conversions?
            </h3>
            <p className="text-xs text-[#424754] dark:text-[#94a3b8] leading-relaxed">
              Standard files up to 50MB convert completely free of charge. For larger files (up to 2GB) or batch multi-file operations, upgrade to Data Converter Pro.
            </p>
          </div>

          <div className="pt-4 border-t border-[#e1e3e4] dark:border-[#262c3a]">
            <h3 className="font-bold text-base text-[#191c1d] dark:text-white mb-1">
              Can I use the REST API in my custom SaaS application?
            </h3>
            <p className="text-xs text-[#424754] dark:text-[#94a3b8] leading-relaxed">
              Yes! Our Developer REST API supports programmatic integrations with cURL, Node.js, Python, PHP, and Go with 10,000 monthly request quotas included in Pro.
            </p>
          </div>

          <div className="pt-4 border-t border-[#e1e3e4] dark:border-[#262c3a]">
            <h3 className="font-bold text-base text-[#191c1d] dark:text-white mb-1">
              Are my documents saved or analyzed for AI training?
            </h3>
            <p className="text-xs text-[#424754] dark:text-[#94a3b8] leading-relaxed">
              Never. We guarantee 100% data privacy. Your files exist only in your browser tab session and are destroyed when you close or refresh the page.
            </p>
          </div>
        </div>
      </div>
